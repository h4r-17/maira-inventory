        ...
        $(document).ready(function() {
            ...
            function createRow(data = {}) {
                const row = $(`
                    <tr>
                        <td>
                            <input type="text" class="form-control barang" autocomplete="off" placeholder="Masukkan nama bahan baku" value="${escapeHtml(data.nama_barang ?? '')}">
                        ...
                        <td>
                            <select class="form-control satuan" name="id_satuan[]" required>${buildSatuanOptions(data.id_satuan ?? '')}</select>
                            </td>
                            <td>
