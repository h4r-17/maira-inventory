...
@section('konten')
    ...
    <div class="mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <h3 class="mb-3 text-gray-900">Detail Pengajuan: {{ $pengajuan->kode_pengajuan }}</h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="font-weight-bold text-gray-900">{{ $pengajuan->no_pengajuan }}</div>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-hover align-middle mb-0 text-gray-900">
                        <thead class="table-secondary">
                            <tr>
                                ...
                                <th class="text-center" style="width: 150px">Nama Bahan Baku</th>
                                ...
                                <th class="text-center" style="width: 140px">Deskripsi</th>
                                <th class="text-center" style="width: 170px;">Subtotal</th>
                            </tr>
                        </thead>
                        <tbody>
